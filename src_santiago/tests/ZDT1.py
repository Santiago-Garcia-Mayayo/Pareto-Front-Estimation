...
from problems import zdt1_f1, zdt1_f2

# Convex performs good, but slow. Modify way of curve (more smooth and no repetition)
# to improve NGSA-II convergence approach.
...
for i in range(MAX_ITER):
    ...
    ax.set_title(f"ZDT1 - Iter {i+1}\nModel Fitting vs Reality")
